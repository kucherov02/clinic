...
class SpecialtiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialty" do
    assert_difference("Specialty.count") do
      post specialties_url, params: { specialty: { doctor_id: @specialty.doctor_id, name: @specialty.name } }
    end
  ...
  test "should update specialty" do
    patch specialty_url(@specialty), params: { specialty: { doctor_id: @specialty.doctor_id, name: @specialty.name } }
